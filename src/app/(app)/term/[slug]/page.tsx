  ...
  return (
    <div className="overflow-x-hidden mb-16">
      <div className="container relative mt-8 md:mt-header mb-16">
        <div className="grid md:grid-cols-[2fr,1fr] gap-10 mb-12 sm:mb-20">
          <div className="flex flex-col gap-10 sm:gap-16">
            <h1 className="font-semibold md:font-bold text-[2rem] sm:text-[3.25rem] md:text-[4rem] leading-10 sm:leading-[4rem] uppercase sm:mt-4">
              {title}
            </h1>
